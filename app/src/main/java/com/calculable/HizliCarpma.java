...
public class HizliCarpma extends Activity {
	...
	public Random r;
	public int gercek;
	public int sonuc1, sonuc2, sonuc3, sonuc4, sonuc5, sonuc6,sonuc7;
	public int i = 1;
	public String go;
	...
	protected void yeniSoru(){
		...
		sonuc7 = array3[r.nextInt(2)];
		
		array = new int[]{sonuc7,gercek};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		sonuc_dialog = new Dialog(HizliCarpma.this);
		...
		mp = MediaPlayer.create(HizliCarpma.this,R.raw.button16);

		prefs = this.getSharedPreferences("hizliCbest", Context.MODE_PRIVATE);
		editor = prefs.edit();
