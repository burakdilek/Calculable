...
public class HizliToplama extends Activity {
	...
	public boolean xa;
	public int ilk;
	public int x=3000, y=300 ;
	public int son;
	public int sonuc;
	public int[] array;
	public Random r;
	public int gercek;
	public int sonuc1, sonuc2, sonuc3;
	public int i = 1;
	public String go;
	...
	protected void yeniSoru(){
		...
		array = new int[]{sonuc1,sonuc2};
		sonuc3 = array[r.nextInt(2)];
		
		array = new int[]{sonuc3,gercek};
		sonuc = array[r.nextInt(2)];
		
		text.setText(String.valueOf(ilk)+" + "+String.valueOf(son)+"\n = "+String.valueOf(sonuc));
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		sonuc_dialog = new Dialog(HizliToplama.this);
		...
		mp = MediaPlayer.create(HizliToplama.this,R.raw.button16);
		
		prefs = this.getSharedPreferences("hizliTbest", Context.MODE_PRIVATE);
		editor = prefs.edit();
